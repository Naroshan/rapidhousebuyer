...
EXISTING_LABELS = {
    ...
    "redbridge":"Redbridge","havering":"Havering","bexley":"Bexley","greenwich":"Greenwich",
    "bromley":"Bromley","sutton":"Sutton","croydon":"Croydon","kingston-upon-thames":"Kingston upon Thames",
    "richmond-upon-thames":"Richmond upon Thames","hillingdon":"Hillingdon","hounslow":"Hounslow",
}
...
{{
  ...
  "mainEntity": [
    {{
      "@type": "Question",
      "name": "Do you buy properties in {name}?",
      "acceptedAnswer": {{
        "@type": "Answer",
        "text": "Yes. Rapid House Buyer is an active cash buyer across {name} and the wider {county} area within the M25 corridor, with in-house RICS surveyors providing same-day valuations. We purchase all property types in any condition &mdash; houses, flats, HMOs, and tenanted properties &mdash; with zero fees and guaranteed completion."
      }}
    }},
    {{
      "@type": "Question",
      "name": "How quickly can you buy my {name} property?",
      "acceptedAnswer": {{
        "@type": "Answer",
        "text": "We provide an indicative offer within 2 hours, survey within 24 hours, and can exchange within 3-7 days. In urgent cases, 24-hour exchange is possible."
      }}
    }}
  ]
}}
  ...
  <meta property="og:url"         content="https://rapidhousebuyer.co.uk/locations/{slug}">
  <meta property="og:title"       content="Sell {name} Fast for Cash | Rapid House Buyer">
  <meta property="og:description" content="We buy properties in {name}, {county} for cash. Same-day valuation, 24-hour exchange, zero fees. Free no-obligation offer within 2 hours.">
  ...
  <meta name="twitter:title"       content="Sell {name} Fast for Cash | Rapid House Buyer">
  <meta name="twitter:description" content="We buy properties in {name}, {county} for cash. Same-day valuation, 24-hour exchange, zero fees.">
  <meta name="twitter:image"       content="https://rapidhousebuyer.co.uk/favicon-512.png">
<script type="application/ld+json">
{{
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "@id": "https://rapidhousebuyer.co.uk/locations/{slug}",
  "name": "Rapid House Buyer",
  "url": "https://rapidhousebuyer.co.uk/locations/{slug}",
  "telephone": "+442071991698",
  "email": "enquiries@rapidhousebuyer.co.uk",
  "image": {{
    "@type": "ImageObject",
    "url": "https://rapidhousebuyer.co.uk/favicon-512.png",
    "width": 512,
    "height": 512
  }},
  "logo": {{
  ...
  "description": "Rapid House Buyer purchases properties in {name}, {county} for cash. Same-day valuation, 24-hour exchange, zero fees. Free offer within 2 hours.",
  "priceRange": "££",
...
{{
  ...
  "itemListElement": [
    {{
      ...
      "position": 1,
      "name": "Home",
      "item": "https://rapidhousebuyer.co.uk"
    }},
    {{
      "@type": "ListItem",
      "position": 2,
      "name": "Locations",
      "item": "https://rapidhousebuyer.co.uk/pages/locations"
    }},
    {{
      "@type": "ListItem",
      "position": 3,
      "name": "{name}",
      "item": "https://rapidhousebuyer.co.uk/locations/{slug}"
    }}
  ]
}}
</script>
...
<section class="section section--charcoal" style="padding:2rem 0">
  <div class="container">
    <div class="local-facts">
      <div class="local-fact"><div class="local-fact__val">{flat_fmt}</div><div class="local-fact__lbl">Avg Flat Price</div></div>
      <div class="local-fact"><div class="local-fact__val">{house_fmt}</div><div class="local-fact__lbl">Avg House Price</div></div>
      <div class="local-fact"><div class="local-fact__val">{yld}%</div><div class="local-fact__lbl">Avg Rental Yield</div></div>
    </div>
    <p style="font-size:.7rem;color:var(--txt-muted);text-align:center;margin-top:.75rem">Indicative data based on Land Registry and market analysis 2024&ndash;25. Individual properties vary.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="content-sidebar">
      <div class="article-body">
        <h2>Selling Your {name} Property for Cash</h2>
        <p>Whether you are a long-term {name} resident looking to release equity quickly, a landlord with {name} buy-to-let properties, or an executor managing an inherited {county} estate, Rapid House Buyer provides a straightforward, confidential purchase service tailored to your timeline.</p>
        <p>We purchase properties across {name} and the surrounding {county} stretch of the M25 corridor, and have in-house RICS-accredited surveyors with detailed knowledge of the local market &mdash; including the considerable variation in value and stock type across different parts of the town.</p>
        <h2>The {name} Property Market</h2>
        <p>{name} is characterised by {stock}. Prices range from around {flat_fmt} for flats to {house_fmt}+ for houses, though individual streets and property types vary significantly.</p>
        <p>Our RICS-accredited surveyors are familiar with the full range of {name}&apos;s residential stock and provide accurate, evidence-based valuations across all property types.</p>
        <h2>Areas of {name} We Cover</h2>
        <p>We purchase across all of {name}, including: <strong>{areas_str}</strong>. If your property is in a specific street or sub-area not listed, please call or WhatsApp us &mdash; our coverage extends across {name} and the surrounding {county} area.</p>
        ...
        <p>Our cash offers typically represent 75&ndash;85% of current open market value for {name} properties. The exact figure depends on type, condition, tenure, and any specific complications. When costs saved &mdash; no agent fees, no legal fees, no months of mortgage payments &mdash; are factored in, the net difference is often smaller than it initially appears.</p>
        <h2>A {name} Client&apos;s Experience</h2>
        <article class="testimonial-card" style="background:var(--bg-cream);max-width:580px;margin-bottom:2rem" itemscope itemtype="https://schema.org/Review">
          <meta itemprop="itemReviewed" content="Rapid House Buyer"><span itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating"><meta itemprop="ratingValue" content="5"><meta itemprop="bestRating" content="5"><meta itemprop="worstRating" content="1"></span>
          <div class="testimonial-card__stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
          <blockquote itemprop="reviewBody">&ldquo;{t_text}&rdquo;</blockquote>
          <div class="testimonial-card__author">
            <div class="testimonial-card__avatar">{t_init}</div>
            <div><div class="testimonial-card__name" itemprop="author">{t_name}</div><div class="testimonial-card__loc">{t_area}</div><div class="testimonial-card__verified">&#10003; Verified Sale {t_year}</div></div>
          </div>
        </article>
        <h2>Frequently Asked Questions &mdash; {name}</h2>
        <div class="faq__list" style="margin-bottom:2rem">
          <div class="faq__item"><button class="faq__question" aria-expanded="false">Do you buy all types of property in {name}?<span class="faq__icon">+</span></button><div class="faq__answer"><p>Yes &mdash; flats, houses, maisonettes, HMOs, and mixed-use properties with a residential element. We buy tenanted and vacant, freehold and leasehold, and in any condition. No property type or condition is outside our remit.</p></div></div>
          <div class="faq__item"><button class="faq__question" aria-expanded="false">How quickly can you survey my {name} property?<span class="faq__icon">+</span></button><div class="faq__answer"><p>Our in-house RICS-accredited surveyors can visit {name} properties typically within 24 hours, and often the same day in urgent cases. There is no charge for the survey and no obligation to proceed afterwards.</p></div></div>
          <div class="faq__item"><button class="faq__question" aria-expanded="false">What are typical property prices in {name}?<span class="faq__icon">+</span></button><div class="faq__answer"><p>Average flat prices in {name} are currently around {flat_fmt} and average house prices approximately {house_fmt}, based on recent Land Registry data. Values vary significantly by street and property type. Our survey provides an accurate, specific assessment for your property.</p></div></div>
          <div class="faq__item"><button class="faq__question" aria-expanded="false">Is {name} within your coverage area?<span class="faq__icon">+</span></button><div class="faq__answer"><p>Yes &mdash; {name} sits within the M25 corridor, roughly {dist} miles from central London near junction {junction}, and is fully within our coverage area. We also purchase throughout the surrounding {county} area.</p></div></div>
        </div>
      </div>
      <div class="sticky-sidebar">
        <div class="sidebar-card">
          <div class="sidebar-card__title">Get {article} {name} Valuation</div>
          <a href="tel:+442071991698" class="sidebar-contact"><div class="sidebar-contact__icon" aria-hidden="true">&#128222;</div><div><div class="sidebar-contact__label">Call Direct</div><div class="sidebar-contact__value">020 7199 1698</div></div></a>
          <a href="https://wa.me/442071991698" class="sidebar-contact" target="_blank" rel="noopener"><div class="sidebar-contact__icon" aria-hidden="true">&#128172;</div><div><div class="sidebar-contact__label">WhatsApp</div><div class="sidebar-contact__value">020 7199 1698</div></div></a>
        ...
        <div class="sidebar-card">
          <div class="sidebar-card__title">Local Data</div>
          <ul style="list-style:none;padding:0;display:flex;flex-direction:column;gap:.5rem">
            <li style="font-size:.8rem;color:var(--txt-sec)"><strong style="color:var(--gold-light)">County:</strong> {county}</li>
            <li style="font-size:.8rem;color:var(--txt-sec)"><strong style="color:var(--gold-light)">M25 junction:</strong> {junction}</li>
            <li style="font-size:.8rem;color:var(--txt-sec)"><strong style="color:var(--gold-light)">Avg flat:</strong> {flat_fmt}</li>
            <li style="font-size:.8rem;color:var(--txt-sec)"><strong style="color:var(--gold-light)">Avg house:</strong> {house_fmt}</li>
            <li style="font-size:.8rem;color:var(--txt-sec)"><strong style="color:var(--gold-light)">Rental yield:</strong> {yld}%</li>
          </ul>
        </div>
        <div class="sidebar-card">
...
<section class="section section--charcoal" id="enquiry">
  <div class="container" style="max-width:860px">
    ...
    <form class="valuation-form" action="https://formspree.io/f/mwvjqywq" method="POST" style="background:var(--bg-card);border:1px solid rgba(37,99,235,.35);border-radius:24px;padding:2.25rem;max-width:540px;margin:2rem auto 0" novalidate>
      ...
      <div class="form__row">
        <div class="form__group"><label class="form__label" for="lf-phone">Phone *</label><input class="form__input" id="lf-phone" name="phone" type="tel" required autocomplete="tel" placeholder="07700 900000"></div>
        <div class="form__group"><label class="form__label" for="lf-postcode">Postcode *</label><input class="form__input" id="lf-postcode" name="postcode" type="text" required placeholder="{name}" autocomplete="postal-code"></div>
      </div>
      <div class="form__group"><label class="form__label" for="lf-reason">Reason for Selling</label>
        <select class="form__select" id="lf-reason" name="reason">
          <option value="">Please select&hellip;</option>
          <option>Facing repossession</option><option>Financial difficulties</option>
          <option>Probate / inherited property</option><option>Divorce / separation</option>
  ...
  <div class="container">
    <div class="footer__grid">
      <div class="footer__brand">
        ...
        <div class="footer__tagline">Cash Property Buyers · London &amp; M25</div>
        <p class="footer__about">Direct cash buyer across all 32 London boroughs and the full M25 corridor. In-house surveyors, same-day valuations, 24-hour exchange.</p>
        <div class="footer__contacts">
          <a href="tel:+442071991698" class="footer__contact">📞 020 7199 1698</a>
          <a href="https://wa.me/442071991698" class="footer__contact" target="_blank" rel="noopener">💬 WhatsApp: 020 7199 1698</a>
...
<a href="https://wa.me/442071991698?text=Hi+I'd+like+a+free+cash+offer" class="whatsapp-float" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp — free cash offer">
  ...
  <span class="whatsapp-float__label">Free Cash Offer</span>
</a>
...
<script>
/* SCROLL + FAQ + FORM + COOKIE + STATS + FADE */
(function(){{
  ...
  document.querySelectorAll('.faq__question').forEach(function(btn){{
    btn.addEventListener('click',function(){{
      ...
      if(list){{ list.querySelectorAll('.faq__question').forEach(function(b){{ b.setAttribute('aria-expanded','false'); var a=b.nextElementSibling; if(a) a.hidden=true; }}); }}
      if(!open){{ btn.setAttribute('aria-expanded','true'); var ans=btn.nextElementSibling; if(ans) ans.hidden=false; }}
    }});
  }});

  document.querySelectorAll('form.valuation-form').forEach(function(form){{
    form.setAttribute('action','https://formspree.io/f/mwvjqywq');
    form.setAttribute('method','POST');
    if(!form.querySelector('input[name="_gotcha"]')){{
      var t=document.createElement('input'); t.type='text'; t.name='_gotcha'; t.style.display='none'; t.tabIndex=-1; form.appendChild(t);
    }}
    form.addEventListener('submit',function(e){{
      e.preventDefault();
      var valid=true;
      form.querySelectorAll('[required]').forEach(function(f){{ if(!f.value.trim()){{ valid=false; f.style.borderColor='#e74c3c'; f.addEventListener('input',function(){{ f.style.borderColor=''; }},{{once:true}}); }} }});
      if(!valid) return;
      var btn=form.querySelector('[type=submit]'), orig=btn?btn.innerHTML:'';
      if(btn){{ btn.disabled=true; btn.innerHTML='Sending&hellip;'; }}
      fetch('https://formspree.io/f/mwvjqywq',{{ method:'POST', body:new FormData(form), headers:{{'Accept':'application/json'}} }})
      ...
      .then(function(j){{
        if(j.ok){{
          ...
          alert('Something went wrong. Please call 020 7199 1698.');
        }}
      }})
      .catch(function(){{ if(btn){{ btn.disabled=false; btn.innerHTML=orig; }} alert('Error. Please call 020 7199 1698.'); }});
    }});
  }});
  ...
  if(banner && !localStorage.getItem('rhb_consent')){{
    ...
    if(a) a.addEventListener('click',function(){{ localStorage.setItem('rhb_consent','all'); banner.classList.remove('visible'); }});
    if(d) d.addEventListener('click',function(){{ localStorage.setItem('rhb_consent','essential'); banner.classList.remove('visible'); }});
  }}

  if('IntersectionObserver' in window){{
    var obs=new IntersectionObserver(function(entries){{ entries.forEach(function(e){{ if(!e.isIntersecting) return; var el=e.target,target=parseFloat(el.dataset.count),suffix=el.dataset.suffix||'',isFloat=String(target).includes('.'),dur=1800,start=performance.now(); (function tick(now){{ var p=Math.min((now-start)/dur,1),ease=1-Math.pow(1-p,3); el.textContent=(isFloat?(ease*target).toFixed(1):Math.round(ease*target))+suffix; if(p<1) requestAnimationFrame(tick); }})(start); obs.unobserve(el); }}); }},{{threshold:0.5}});
