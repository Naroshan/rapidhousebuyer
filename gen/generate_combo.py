  ...
  <section class="section section--charcoal" id="enquiry">
    <div class="container" style="max-width:700px">
      ...
      <form class="valuation-form" action="https://formspree.io/f/mwvjqywq" method="POST" style="background:var(--bg-card);border:1px solid rgba(37,99,235,.35);border-radius:24px;padding:2.25rem;max-width:520px;margin:2rem auto 0" novalidate>
        ...
        <div class="form__row">
          <div class="form__group"><label class="form__label" for="cf-phone">Phone *</label><input class="form__input" id="cf-phone" name="phone" type="tel" required autocomplete="tel" placeholder="07700 900000"></div>
          <div class="form__group"><label class="form__label" for="cf-postcode">Postcode *</label><input class="form__input" id="cf-postcode" name="postcode" type="text" required placeholder="Your postcode" autocomplete="postal-code"></div>
        </div>
        <div class="form__consent"><input type="checkbox" id="cf-gdpr" name="gdpr" required><label for="cf-gdpr">I consent to being contacted. <a href="/pages/privacy">Privacy Policy</a>.</label></div>
...
<div class="cookie-banner" id="cookieBanner" role="dialog" aria-label="Cookie consent">
  <p>We use cookies to improve your experience. <a href="/pages/privacy">Privacy Policy</a> &middot; <a href="/pages/cookies">Cookie Policy</a>.</p>
