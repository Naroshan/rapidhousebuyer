...
def render_faq(code, area_name, parent_name, parent_slug):
    faqs = [
        (f"Do you buy houses in all parts of {code}?",
         f"Yes — {code} covers {area_name}, and we purchase flats, houses, maisonettes and HMOs anywhere within it, freehold or leasehold, tenanted or vacant, in any condition."),
        (f"Is {code} covered by your {parent_name} team?",
         f"Yes. {code} falls within the London Borough of {parent_name}, and our in-house surveyors who work across {parent_name} are familiar with the specific streets and property types in {area_name}. See our <a href=\"{parent_slug}.html\">{parent_name} borough page</a> for the wider area."),
        (f"How quickly can you survey a property in {code}?",
         f"Typically within 24 hours of enquiry, and often the same day. There is no charge for the survey and no obligation to proceed with our offer."),
    ]
    return faqs
...
def render_page(slug, d):
    ...
    canonical = f"https://rapidhousebuyer.co.uk/locations/{slug}"

    faq_schema_items = ",".join(
        '{"@type":"Question","name":"%s","acceptedAnswer":{"@type":"Answer","text":"%s"}}' % (
            esc(q), esc(a.replace(f'<a href="{parent_slug}.html">', '').replace('</a>', '').replace(f'{parent_name} borough page', f'{parent_name} borough page'))
        ) for q, a in faqs
    )
    # simpler: strip html tags from schema text
    import re
    def strip_tags(s):
        return re.sub(r'<[^>]+>', '', s)
    faq_schema_items = ",".join(
        '{"@type":"Question","name":"%s","acceptedAnswer":{"@type":"Answer","text":"%s"}}' % (
            esc(q), esc(strip_tags(a))
        ) for q, a in faqs
    )

    faq_html = "\n".join(
        f'          <div class="faq__item"><button class="faq__question" aria-expanded="false">{q}<span class="faq__icon">+</span></button><div class="faq__answer"><p>{a}</p></div></div>'
        for q, a in faqs
    )
...
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{faq_schema_items}]}}</script>
...
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"LocalBusiness","@id":"{canonical}","name":"Rapid House Buyer","url":"{canonical}","telephone":"+442071991698","email":"enquiries@rapidhousebuyer.co.uk","image":{{"@type":"ImageObject","url":"https://rapidhousebuyer.co.uk/favicon-512.png","width":512,"height":512}},"logo":{{"@type":"ImageObject","url":"https://rapidhousebuyer.co.uk/favicon-512.png","width":512,"height":512}},"address":{{"@type":"PostalAddress","streetAddress":"30 St Mary Axe","addressLocality":"London","postalCode":"EC3A 8BF","addressCountry":"GB"}},"areaServed":{{"@type":"PostalCodeArea","name":"{code}"}},"description":"Rapid House Buyer purchases properties in {code} ({area_name}) for cash. Same-day valuation, 24-hour exchange, zero fees. Free offer within 2 hours.","priceRange":"££","openingHoursSpecification":[{{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday"],"opens":"08:00","closes":"20:00"}},{{"@type":"OpeningHoursSpecification","dayOfWeek":"Saturday","opens":"09:00","closes":"17:00"}}],"geo":{{"@type":"GeoCoordinates","latitude":51.5141,"longitude":-0.0826}},"sameAs":["https://www.facebook.com/profile.php?id=61590900291698&locale=en_GB"]}}</script>
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{{"@type":"ListItem","position":1,"name":"Home","item":"https://rapidhousebuyer.co.uk"}},{{"@type":"ListItem","position":2,"name":"Locations","item":"https://rapidhousebuyer.co.uk/pages/locations"}},{{"@type":"ListItem","position":3,"name":"{code}","item":"{canonical}"}}]}}</script>
</head>
...
<div class="urgency-bar"><span class="urgency-bar__dot"></span>Actively purchasing in <strong>{code}</strong> &mdash; <a href="tel:+442071991698">020 7199 1698</a> or <a href="https://wa.me/442071991698" target="_blank" rel="noopener">WhatsApp</a></div>
<header class="site-header" id="siteHeader">
  <div class="header-inner">
    <a href="/" class="logo"><span class="logo__main">Rapid <em>House</em> Buyer</span><span class="logo__sub">Cash Property Buyers &middot; London &amp; M25</span></a>
...
<div class="page-hero">
  <div class="container">
    <nav aria-label="Breadcrumb" style="margin-bottom:1.5rem"><ol class="breadcrumb-list"><li class="breadcrumb-item"><a href="/">Home</a><span class="breadcrumb-sep">&rsaquo;</span></li><li class="breadcrumb-item"><a href="/pages/locations">Locations</a><span class="breadcrumb-sep">&rsaquo;</span></li><li class="breadcrumb-item">{code}</li></ol></nav>
  ...
  <div class="container">
    <div class="content-sidebar">
      <div class="article-body">
        <h2>Selling Your {code} Property for Cash</h2>
        <p>{code} is one of the postcode districts within the London Borough of {parent_name}, covering {area_name}. We have been purchasing properties across {parent_name} since 2012 and understand the specific characteristics of the {code} residential market in detail.</p>
        <div style="background:var(--bg-cream);border-radius:var(--r12);padding:1.5rem;margin:1.5rem 0;display:grid;grid-template-columns:1fr 1fr;gap:1rem">
        ...
        <h2>Why Homeowners in {code} Choose Us</h2>
        <p>We work with {code} homeowners across a range of circumstances: financial difficulty, repossession risk, probate and inherited properties, landlord portfolio exits, divorce-related sales, and urgent relocations. Every situation is different, and every enquiry is treated with complete discretion.</p>
        <h2>What We Offer for {code} Properties</h2>
        <p>Our cash offers for {code} properties typically represent 75&ndash;85% of current open market value. The exact figure depends on property type, condition, tenure, and specific complications. When the costs of a conventional sale &mdash; agent fees, legal fees, months of mortgage payments, and the risk of a buyer pulling out &mdash; are factored in, the net difference is often considerably smaller than it first appears.</p>
        <div class="faq__list" style="margin:2rem 0">
{faq_html}
        </div>
        <p style="margin-top:1.5rem"><a href="{parent_slug}.html" class="btn btn--outline-dark btn--sm">&#8592; Back to {parent_name} Borough Page</a></p>
      </div>
      <div class="sticky-sidebar">
        ...
        <div class="sidebar-card">
          <div class="sidebar-card__title">Also in {parent_name}</div>
          <a href="{parent_slug}.html" class="footer__link" style="display:block;margin-bottom:.4rem">&#8594; {parent_name} Borough Page</a>
          <a href="/pages/services" class="footer__link" style="display:block;margin-bottom:.4rem">&#8594; All Our Services</a>
          <a href="/pages/faq" class="footer__link" style="display:block">&#8594; Frequently Asked Questions</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="section section--charcoal" id="enquiry">
  <div class="container" style="max-width:700px">
    ...
    <form class="valuation-form" action="https://formspree.io/f/mwvjqywq" method="POST" style="background:var(--bg-card);border:1px solid rgba(37,99,235,.35);border-radius:24px;padding:2.25rem;max-width:520px;margin:2rem auto 0" novalidate>
      ...
      <div class="form__row">
        <div class="form__group"><label class="form__label" for="sf-phone">Phone *</label><input class="form__input" id="sf-phone" name="phone" type="tel" required autocomplete="tel" placeholder="07700 900000"></div>
        <div class="form__group"><label class="form__label" for="sf-postcode">Postcode *</label><input class="form__input" id="sf-postcode" name="postcode" type="text" required placeholder="e.g. {code}" autocomplete="postal-code"></div>
      </div>
      <div class="form__consent"><input type="checkbox" id="sf-gdpr" name="gdpr" required><label for="sf-gdpr">I consent to being contacted. <a href="/pages/privacy">Privacy Policy</a>.</label></div>
      <button type="submit" class="btn btn--primary btn--lg btn--full">Get My Free Cash Offer &rarr;</button>
      <p class="form__reassurance">&#128274; Strictly confidential.</p>
    </form>
  </div>
</section>
  ...
  <div class="container">
    <div class="footer__grid">
      <div class="footer__brand">
        ...
        <div class="footer__tagline">Cash Property Buyers &middot; London &amp; M25</div>
        <p class="footer__about">Direct cash buyer across all 32 London boroughs and within the M25. In-house surveyors, same-day valuations, 24-hour exchange.</p>
      ...
      <div>
        ...
        <a href="/locations/camden" class="footer__link">Camden</a>
        <a href="/locations/hackney" class="footer__link">Hackney</a>
        <a href="/locations/islington" class="footer__link">Islington</a>
        <a href="/locations/southwark" class="footer__link">Southwark</a>
        <a href="/locations/tower-hamlets" class="footer__link">Tower Hamlets</a>
        <a href="/locations/wandsworth" class="footer__link">Wandsworth</a>
        <a href="/pages/locations" class="footer__link">All 120+ Locations &rarr;</a>
      </div>
      <div>
...
def main():
    for slug, d in POSTCODES.items():
        html = render_page(slug, d)
